		...
		>
			...
			<div className="flex flex-col gap-10 xl:flex-row xl:items-center xl:justify-center">
				...
				<div className="helvetica am-animate flex flex-col items-start gap-7 text-white xl:w-[40%]">
					<p>
						This cinematic short film, created by Ayush Karki, has been
						completely rebuilt from scratch, from sound design to music, giving
						the soundtrack a more modern twist. <br /> The music features
						predominantly synthetic compositions, combined with vocals and
						electric guitar.
					</p>
				</div>
			</div>
